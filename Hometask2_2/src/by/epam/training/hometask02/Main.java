...
//Создайте класс Payment (покупка), сформируйте покупку из нескольких товаров. (Помните, что вы решаете задачу с использование ООП подхода – т.е. создавайте нужные для решения классы с подходящими методами, а не пишите процедурный код в одном методе, или даже в нескольких, но статических.)
